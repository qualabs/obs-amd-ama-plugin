#ifndef _AMA_CONTEXT_H_
#define _AMA_CONTEXT_H_
...
typedef struct {
	...
	DARRAY(int64_t) dts_array;
	int32_t codec;
	DARRAY(uint8_t) packet_data;
	ScalerProps abr_params;
	XmaScalerProperties abr_xma_props;
	XrmScaleContext scaler_xrm_ctx;
	XmaScalerSession *scl_session;
	XmaFrame *scaler_input_xframe;
